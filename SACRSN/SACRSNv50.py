# ============================================================
# SACRSN v50: SHAPE-CORRECTED STABLE SYSTEM
# ------------------------------------------------------------
...
# 4. FIXES INCLUDED:
#    - Fixed BCE Loss Shape Mismatch (Scalar vs Vector).
#    - Includes all previous v46 stability patches.
# ============================================================
...
def train():
    ...
    print(f"--- Training SACRSN v50 (Fixed Shape Error) ---")
    ...
    for epoch in range(CONFIG["epochs"]):
        ...
        for i in range(len(data_tensor) - 1):
            ...
            # Probe Loss FIX: Ensure shapes match
            probe_target = torch.sigmoid(entropy).detach()
            # Mean() both sides to ensure scalar vs scalar comparison
...
if __name__ == "__main__":
    ...
    torch.save(trained_model.state_dict(), "sacrsn_v50_fixed.pth")
    print("Complete.")
