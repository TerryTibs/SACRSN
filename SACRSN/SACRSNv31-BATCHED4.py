# ============================================================
# SACRSN v31: THE OBSERVABLE EDITION (BATCHED & STABILIZED)
# Fixes: Batching Logic, Gradient Explosion, Codebook Collapse
# Status: READY TO RUN
# ============================================================
...
CONFIG = {
    ...
    "act_threshold": 0.95,       # Lowered to stop over-pondering
    "ponder_penalty": 0.00001,   # Lowered to prevent loss dominance
    ...
    # Topology & Stability
    "commitment_cost": 0.25,     # Increased to stop VQ wobble
    "graph_bias_scale": 0.8,        
    "symbol_consistency_weight": 0.01,
    "ethical_weight": 0.005,
    "diversity_weight": 0.5,     # Restored pressure
    "entropy_weight": 0.001,     # Added explicitly
    
    # Training
    "epochs": 3000,
    "learning_rate": 3e-4,       # Increased to 3e-4 for speed
    "grad_clip": 0.5,
    "eps": 1e-6,
    "warmup_epochs": 0
}
