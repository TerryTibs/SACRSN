# ============================================================
# SACRSN v45: STABLE HYPER-INTEGRATION (FINAL PATCHED)
# ------------------------------------------------------------
...
#    - Fixed Dream Mode (Flat to Complex casting).
# ============================================================
...
def train():
    ...
    print(f"--- Training SACRSN v45 (Stable Hyper-Integration) ---")
...
# [FIXED] Dream Mode (Flat to Complex)
def dream_mode(model):
    ...
    for _ in range(50):
        ...
        # Get raw codebook vector (Real, size: dim*2)
        z_flat = model.vq.codebook[next_idx].unsqueeze(0)
        
        # FIX: Cast to Complex before passing to Quantum Layer
...
if __name__ == "__main__":
    ...
    torch.save(trained_model.state_dict(), "sacrsn_v44_stable.pth")
    print("Complete.")
